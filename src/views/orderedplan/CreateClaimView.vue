  ...
  <main class="w-full min-h-screen">
    <div class="px-8 py-8">
      ...
      <div class="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 mb-6">
        <h3 class="text-lg font-extrabold text-blue-800 mb-2 field-bold">
      ...
      <div class="rounded-xl border border-slate-200 bg-white">
        <div class="p-5">
          <div class="grid grid-cols-1 gap-4">
            ...
            <div>
              <VTextArea
                ...
                @blur="
                  () => {
                    if (!proof.trim()) proofError = 'Proof is required'
                  }
                "
              />
          ...
          <div class="flex justify-end gap-3 mt-6">
            <VButton variant="secondary" size="md" :disabled="isSubmitting" @click="cancel"
              >Cancel</VButton
            >
            <VButton
              variant="orange"
